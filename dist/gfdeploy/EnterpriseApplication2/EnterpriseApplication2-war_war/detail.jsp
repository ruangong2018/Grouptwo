...
<body class="tour-page">
    ...
    <div class="wrapper">
        ...
        <section id="features" class="features section">
            ...
            <%
            String search=(String)request.getParameter("detail");
            try{
             ...
             //   String str1=request.getParameter("proname");
              //  ResultSet rs = st.executeQuery("SELECT 价格 FROM Sale WHERE 商品编号=4"); 
               ResultSet rs = st.executeQuery("Select * FROM 旅游线路表 WHERE 旅游线路表.旅游路线序号='"+search+"'");
               rs.next();
        ...
        <div id='footer'>
            <form action="crtlservlet" class='content col-md-1 col-sm-1 col-xs-12 pull-right col-md-offset-10 col-sm-offset-10 col-xs-offset-10 from-right' method ="post">
                <input type="submit" value="订购">
                <input type="hidden" name="hidtype" value="2">
                <input type="hidden" name="routenum" value="<%=search%>">
