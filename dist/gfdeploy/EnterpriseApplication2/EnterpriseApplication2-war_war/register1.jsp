        ...
        <h1>游客注册</h1>
         ...
         <form method="POST" action="crtlservlet">
            ...
            <table border="2" >
                <tr>
                    <th>邮箱：</th>
                    <th><INPUT TYPE="TEXT" NAME="mail" required="required"><p></th>
                </tr>
                <tr>
                    <th>用户名：</th>
                    <th><INPUT TYPE="TEXT" NAME="username" required="required"><p></th>
                </tr>
                <tr>
                    <th>密码：</th>
                ...
                <tr>
                    <th>身份证号：</th>
                    <th><INPUT TYPE="TEXT" NAME="id_num" required="required"><p></th>
                </tr>
                <tr>
                    <th>联系方式：</th>
                    <th><INPUT TYPE="TEXT" NAME="phone" required="required"><p></th>
                </tr>
                <table border="1">
                <tr>
            ...
            <input type="hidden" name="hidtype" value="5">
        </form>
            <!-- Javascript -->          
